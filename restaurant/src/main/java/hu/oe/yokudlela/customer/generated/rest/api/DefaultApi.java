 ...
 */
package hu.oe.yokudlela.customer.generated.rest.api;
...
public interface DefaultApi {
     ...
     *         or Menüelem nem található (status code 404)
     */
    @Operation(
        ...
        responses = {
            ...
            @ApiResponse(responseCode = "404", description = "Menüelem nem található")
        }
    )
    @RequestMapping(
